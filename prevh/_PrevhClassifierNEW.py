...
class PrevhClassifier:
    ...
    def predict(self, *args, **kwargs):
        ...
        for lab in self.labels:
            ...
            if cur_label_dist != 0: results += [1 - (cur_label_dist / total_dist_sum)]
            else: results += [np.NaN]
    ...
    def calculateScore(self, scoreMethod, **kwargs):
        ...
        if scoreMethod == "TrainTestSplit":
            ...
            for i in X_test.values:
                if i[labelIndex] == self.predict(X_train, i, k=k, algorithm=algorithm): correctPredictions += 1
        ...
        if scoreMethod == "KFold":
            ...
            for i in indexFold:
                ...
                for y in test_set.values:
                    if y[labelIndex] == self.predict(train_set, y, k=k, algorithm=algorithm): correctPredictions += 1
